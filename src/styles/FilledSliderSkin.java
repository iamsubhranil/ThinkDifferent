...
//        horizontal = getSkinnable().isVertical();
        ...
        track.setOnMousePressed((MouseEvent me) -> {
            mousePressedOnTrack(me);
        });
        track.setOnMouseDragged((MouseEvent me) -> {
            mouseDraggedOnTrack(me);
        });
        fill.setOnMousePressed((MouseEvent me) -> {
            mousePressedOnTrack(me);
        });
        fill.setOnMouseDragged((MouseEvent me) -> {
            mouseDraggedOnTrack(me);
        });

        thumb.setOnMousePressed((MouseEvent me) -> {
        ...
        thumb.setOnMouseReleased((MouseEvent me) -> {
            getBehavior().thumbReleased(me);
        });

        thumb.setOnMouseDragged((MouseEvent me) -> {
